import {setLanguage, setSearchText, setSelectedTags, setStatus, setTags} from '../action/appAction';
...
export type ActionAppType = SetStatusType | SetLanguageType | SetSearchTextType | SetTagsType | SetSelectedTagsType
